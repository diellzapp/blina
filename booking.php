            ...
            <div class="booking-form-container">
                <form action="verify.php" method="POST">
                    ...
                    <select name="type" required>
                        ...
                        <option value="7d">6D</option>
                    </select>

                    <select name="date" required>
                        <option value="" disabled selected>DATE</option>
                        <option value="27-5">May 27,2023</option>
                        <option value="28-5">May 28,2023</option>
                        <option value="29-5">May 29,2023</option>
                        <option value="30-5">May 30,2023</option>
                        <option value="31-5">May 31,2023</option>
                    </select>
